const KFont = (function() {
    ...
    const LIBRARY = {
        ...
        "1": `${TOWER(22, 12)} ${SW(4, 25, 20)}`,
        "2": `${AU(6)} ${SW(34, 44, 4)} ${AL(40, 42, 70)} ${SW(68, 44, 4)}`,
        "3": `${AU(6)} ${SW(34, 38, 10)} ${AD(6)} ${AR(38, 10, 70)}`,
        "4": `${LANCE(10, 4, 10, 40, 6)} ${SW(34, 44, 4)} ${TOWER(30, 4, 76)}`,
        "5": `${SW(4, 44, 4)} ${AL(10, 4, 40)} ${SW(34, 44, 4)} ${AD(6)} ${AR(38, 40, 76)}`,
        "6": `${AU(6)} ${AL(12, 10, 70)} ${SW(34, 38, 10)} ${AD(6)} ${AR(38, 40, 70)}`,
        "7": `${SW(4, 44, 4)} ${LANCE(44, 4, 12, 76, 6)}`,
        "8": `${AU(6)} ${AD(6)} ${AL(12, 10, 70)} ${AR(38, 10, 70)} ${SW(34, 44, 6)}`,
        "9": `${AU(6)} ${AL(12, 10, 40)} ${SW(34, 38, 10)} ${AR(38, 10, 70)} ${AD(6)}`,
        "*": GLOW_RING(25, 40, 15)
    };
