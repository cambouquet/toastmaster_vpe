export const getModelNodes = (t) => {
  const b = Math.sin(t*0.001)*0.02, f = Math.sin(t*0.003)*0.05, n = {};
  const add = (k, v) => n[k] = v;
  ...
  ['l','r'].forEach(s => {
    // Thumb remains unique (T), while I, M, R, P follow a tighter, unified palm spacing.
    const args = [['T',-0.035,0,0.03,0.035,true], ['I',-0.015,0,0.005,0.07], ['M',0,0,0,0.08], ['R',0.015,0,-0.005,0.07], ['P',0.03,0,-0.012,0.05]];
