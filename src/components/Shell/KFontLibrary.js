...
export const K_FONT_LIBRARY = {
  ...
  "1": { path: `${LANCE(15, 20, 25, 4, 3)} ${TOWER(22)}`, width: 50 },
  "2": { path: `${AU(6)} ${BRIDGE(44, 20, 44, 40, 6, 76)} ${SW(68, 44, 10)}`, width: 50 },
  "3": { path: `${AU(6)} ${AD(6)} ${SW(34, 38, 12)} ${AR(38, 15, 65)}`, width: 50 },
  "4": { path: `${TOWER(35)} ${LANCE(35, 4, 6, 45, 5)} ${SW(38, 46, 6)}`, width: 50 },
  "5": { path: `${SW(4, 44, 10)} ${TOWER(12, 4, 40)} ${SW(34, 38, 12)} ${AD(8, 20)} ${AR(38, 40, 65)}`, width: 50 },
  "6": { path: `${AU(6)} ${AD(10)} ${AL(12)} ${AR(38, 40, 65)} ${SW(34, 38, 12)}`, width: 50 },
  "7": { path: `${SW(4, 44, 10)} ${LANCE(44, 4, 15, 76, 6)}`, width: 50 },
  "8": { path: `${AU(6)} ${AD(6)} ${AL(12)} ${AR(38)} ${SW(34, 38, 10)}`, width: 50 },
  "9": { path: `${AU(6)} ${AD(6)} ${AL(12, 20, 40)} ${AR(38)} ${SW(34, 38, 10)}`, width: 50 }
};
