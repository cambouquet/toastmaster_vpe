    ...
    <div className="mc-grid">
      <div className="mc-card telemetry">
        ...
        <div className="stats">
          ...
          <div className="stat"><span className="l">LATENCY</span><span className="v">12MS</span></div>
        </div>
      </div>
      <div className="mc-card user-profile">
        <div className="lbl">USER RANK</div>
        <div className="val">ELITE ARCHITECT</div>
        <div className="xp-bar"><div className="fill" style={{width: '75%'}} /></div>
      ...
      <div className="mc-card alerts">
        ...
        <div className="log">> SYSTEM REINDEX COMPLETE</div>
      </div>
    </div>
    <div className="mc-main-visual">
      <div className="hex-grid" />
      <div className="core-sync">CORE_SYST_SYNC: 99.9%</div>
    </div>
  </div>
);